...
#include "image_interfaces/srv/detail/movement__rosidl_typesupport_fastrtps_c.h"
...
using _Movement_Request__ros_msg_type = image_interfaces__srv__Movement_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _Movement_Request__ros_msg_type * ros_message = static_cast<_Movement_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
...
size_t get_serialized_size_image_interfaces__srv__Movement_Request(
  const void * untyped_ros_message,
...
static uint32_t _Movement_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_image_interfaces__srv__Movement_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_image_interfaces
size_t max_serialized_size_image_interfaces__srv__Movement_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = image_interfaces__srv__Movement_Request;
    is_plain =
      (
...
static size_t _Movement_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_image_interfaces__srv__Movement_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, image_interfaces, srv, Movement_Request)() {
...
using _Movement_Response__ros_msg_type = image_interfaces__srv__Movement_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _Movement_Response__ros_msg_type * ros_message = static_cast<_Movement_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: relative_centroid
  {
    cdr >> ros_message->relative_centroid;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_image_interfaces
size_t get_serialized_size_image_interfaces__srv__Movement_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Movement_Response__ros_msg_type * ros_message = static_cast<const _Movement_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_image_interfaces__srv__Movement_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_image_interfaces
size_t max_serialized_size_image_interfaces__srv__Movement_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = image_interfaces__srv__Movement_Response;
    is_plain =
      (
      offsetof(DataType, intersection) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Movement_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_image_interfaces__srv__Movement_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, image_interfaces, srv, Movement_Response)() {
...
// already included above
// #include "image_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "image_interfaces/srv/movement.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, image_interfaces, srv, Movement)() {
